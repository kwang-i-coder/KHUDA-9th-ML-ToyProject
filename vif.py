...
df['House_Type_Multi_Family'] = encoder.fit_transform(df['House_Type_Multi_Family'])
df['House_Type_Multi_Unit'] = encoder.fit_transform(df['House_Type_Multi_Unit'])
df['House_Type_Row_House'] = encoder.fit_transform(df['House_Type_Row_House'])
df['House_Type_Single_House'] = encoder.fit_transform(df['House_Type_Single_House'])
df['House_Type_Villa'] = encoder.fit_transform(df['House_Type_Villa'])
df['Rent_Type_Jeonse'] = encoder.fit_transform(df['Rent_Type_Jeonse'])
df['Orientation_East'] = encoder.fit_transform(df['Orientation_East'])
df['Orientation_South'] = encoder.fit_transform(df['Orientation_South'])
df['Orientation_West'] = encoder.fit_transform(df['Orientation_West'])
# # Cluster 값이 -1인 행 제거
...
plt.legend()
plt.tight_layout()
plt.savefig('vif_analysis_2.png', dpi=150)
plt.show()
